...
// Few-shot examples: user message + assistant tool_use response.
...
const FEW_SHOT_MESSAGES = [
  ...
  {
    role: "user",
    content: "Concept: A tightrope walker maintaining balance under uncertain conditions.\nSub-tent: COE Circus\nOSI Layer: 7"
  },
  {
    role: "assistant",
    content: [
  ...
  {
    role: "user",
    content: "Concept: The impressive outcome at the end of a project, where everything is justified after the fact.\nSub-tent: COE Circus\nOSI Layer: 7"
  },
  {
    role: "assistant",
    content: [
